...
import com.joshuacrotts.raycaster.commands.WallBuilder;
...
public class Raycaster extends ThetaGraphicalApplication {
    ...
    public Raycaster() throws IOException {
        ...
        this.MAX_WALLS = 100;
        this.texture = ImageIO.read(new File("brick.png"));
        this.addMouseListener(new WallBuilder(this));
        this.generateWalls();
    }
    ...
    private ArrayList<Line2D.Double> calcRays(ArrayList<Wall> walls, int resolution, int maxDist) {
        ...
        if (mx > this.getGameWidth() / 2.0 || mx < 0) {
            return rays;
        }
        ...
        for (int r = 0; r < resolution; r++) {
            ...
            ray.x2 = Math.min(ray.x2, this.getGameWidth() / 2.0);
            rays.add(ray);
